...
-- --------------------------------------------------
-- Date Created: 09/14/2025 13:16:17
...
IF OBJECT_ID(N'[dbo].[FK_GuildMember]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TGuildMembers] DROP CONSTRAINT [FK_GuildMember];
GO
...
-- Creating non-clustered index for FOREIGN KEY 'FK_GuildApply'
